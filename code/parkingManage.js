...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parkingManage = __webpack_require__(258);
	
	var _parkingManage2 = _interopRequireDefault(_parkingManage);
	...
	var app = new _vue2.default({
	    ...
	    render: function render(h) {
	        return h(_parkingManage2.default);
	    }
	}).$mount('#app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "F:\\open_team\\static\\developer\\src\\view\\page\\parkingManage.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-42d37fc3", __vue_options__)
	  } else {
	    hotAPI.reload("data-v-42d37fc3", __vue_options__)
	  }
	})()}
	if (__vue_options__.functional) {console.error("[vue-loader] parkingManage.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  mounted: function mounted() {
	    ...
	    me.$http.get('http://bimface.com/console/share/preview/viewtoken?token=8d21e764').then(function (res) {
	      if (res.data.code == 'success') {
	        var successCallback = function successCallback() {
	          ...
	          me.viewer3D.addEventListener(Glodon.Bimface.Viewer.Viewer3DEvent.ViewAdded, function () {
	            ...
	            me.$http.get('http://bimface.com/example/park/all').then(function (res) {
	              me.tree = res.data;
	            ...
	            me.$http.get('http://bimface.com/example/park/list?valid=false').then(function (res) {
	              me.employ = res.data.length;
	              res.data.forEach(function (fun) {
	                me.parkEmploy.push(fun.elementId);
	              });
	              var parkEmployColor = new Glodon.Web.Graphics.Color(255, 0, 0, 0);
	  ...
	  methods: {
	    ...
	    showPark: function showPark(parkId) {
	    ...
	    parkPoint: function parkPoint(parkId) {
	      this.resetView();
	      this.parkHighArr.push(parkId);
	      var highColor = new Glodon.Web.Graphics.Color(255, 255, 0, 0);
	    ...
	    showPerson: function showPerson() {
	      var me = this;
	      me.$http.get('http://bimface.com/example/park/user').then(function (res) {
	        //创建DrawableContainer
	        me.tagArr = [];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "title"
	  }, [_vm._v("停车位列表")]), _vm._v(" "), _c('div', {
	    staticClass: "tab"
	  }, _vm._l((_vm.tree), function(item, i) {
	    return _c('a', {
	      class: {
	        'cur': _vm.isFloor == item.floor
	      },
	      attrs: {
	    ...
	    }, [_vm._v(_vm._s(item.floor))])
	  })), _vm._v(" "), (_vm.tree) ? _c('div', {
	    staticClass: "list"
	  }, _vm._l((_vm.tree), function(item, i) {
	    return _c('dl', {
	      class: {
	        'show': _vm.isFloor == item.floor
	      }
	    }, _vm._l((item.exampleParkList), function(park) {
	      return _c('dt', {
	        on: {
	          "click": function($event) {
	            _vm.showPark(park.elementId)
	          }
	        }
	      }, [_c('span', [_vm._v(_vm._s(park.parkNumber))])])
	    }))
	  })) : _vm._e(), _vm._v(" "), _c('div', {
	    staticClass: "park-state"
	  }, [_vm._v("\n        停车位：" + _vm._s(_vm.total)), _c('br'), _vm._v("\n        已停车位："), _c('span', [_vm._v(_vm._s(_vm.employ))])])]), _vm._v(" "), _c('section', {
	    staticClass: "main"
	  }, [_c('div', {
	    attrs: {
	      "id": "view3d"
	    ...
	    staticClass: "person-state"
	  }, [_vm._v("\n        车库当前人数："), _c('span', [_vm._v(_vm._s(_vm.personSum))]), _vm._v("人\n        "), (_vm.user) ? [_vm._v("，当前用户："), _c('span', [_vm._v(_vm._s(_vm.user))])] : _vm._e(), _vm._v(" "), (_vm.parkNum) ? [_vm._v("，车位："), _c('span', [_vm._v(_vm._s(_vm.parkNum))])] : _vm._e()], 2)])])])
	},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('header', [_c('section', {
	    staticClass: "title"
	  }, [_vm._v("基于BIM智慧停车的室内定位示例")])])
	}]}
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-42d37fc3", module.exports)
	  }
	}
